...
WpLibs/Kernel/Http/BaseController.php
...
```php
WpLibs/Controllers/AppController.php
```
...
- Controllers: WpLibs/Controllers/*
- Kernel HTTP layer: WpLibs/Kernel/Http
