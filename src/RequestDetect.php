...
class RequestDetect {
    ...
    public static function detect() {
        if (!defined('WPLIBS_IS_ADMIN')) {
            ...
            define('WPLIBS_IS_FRONT', !$is_admin && !defined('DOING_AJAX') && !$is_rest);
            define('WPLIBS_IS_AJAX', defined('DOING_AJAX') && DOING_AJAX);
            define('WPLIBS_IS_CRON', defined('DOING_CRON') && DOING_CRON);
        }
    }
